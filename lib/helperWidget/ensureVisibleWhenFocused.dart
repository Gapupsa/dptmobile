...
class _EnsureVisibleWhenFocusedState extends State<EnsureVisibleWhenFocused> with WidgetsBindingObserver  {
  ...
  Future<Null> _ensureVisible() async {
    ...
    RevealedOffset ro1 = viewport.getOffsetToReveal(object, 0.0);
    RevealedOffset ro2 = viewport.getOffsetToReveal(object, 1.0);

    if (position.pixels > ro1.offset) {
      // Move down to the top of the viewport
      alignment = 0.0;
    } else if (position.pixels < ro2.offset){
